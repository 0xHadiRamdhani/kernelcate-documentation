...
export default function Profile() {
    return (
        <div className="relative z-10 mb-8 p-6 bg-black/50 backdrop-blur-sm border border-red-500/30 rounded-xl max-w-4xl mx-auto">
            <div className="flex flex-col lg:flex-row items-center space-y-6 lg:space-y-0 lg:space-x-8">
                {/* Avatar/Profile Image */}
                <div className="flex-shrink-0">
                    <div className="w-24 h-24 rounded-full overflow-hidden border-2 border-red-400 shadow-lg shadow-red-500/50">
                        <Image
                            src="/profile.jpg"
                            alt="Hadi Ramdhani"
                            width={96}
                ...
                <div className="flex-1 text-center lg:text-left">
                    <h2 className="text-3xl font-bold text-white mb-3 white-glow">
                        Hadi Ramdhani
                    </h2>
                ...
                <div className="flex flex-col space-y-3">
                    <a
                        ...
                        className="flex items-center px-6 py-3 bg-gray-800 hover:bg-gray-700 text-white rounded-lg transition-all duration-300 hover:scale-105 text-base"
                    >
            ...
            <div className="mt-6 pt-6 border-t border-red-500/20">
                <div className="flex justify-center space-x-8 text-base text-gray-400">
